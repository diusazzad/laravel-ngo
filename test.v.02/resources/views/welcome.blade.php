                            ...
                            <div class="sidebar-submenu  ">
                                <ul>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/ngolab/user/loan/plans" class="nav-link">
                                    ...
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/ngolab/user/loan/pending" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Pending</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/ngolab/user/loan/active" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Active</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/ngolab/user/loan/paid" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Paid</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/ngolab/user/loan/closed" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Closed</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/ngolab/user/loan/all" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                        ...
                        <li class="sidebar-menu-item sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu  ">
                                <ul>
                                    ...
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/ngolab/user/savings/paid" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Paid</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/ngolab/user/savings/closed"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">Closed</span>
                                        </a>
                                    ...
                                    <li class="sidebar-menu-item  ">
                                        <a href="https://script.viserlab.com/ngolab/user/savings/all"
                                            class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">All</span>
                                        </a>
        ...
        <nav class="navbar-wrapper">
            ...
            <div class="navbar__right">
                <a href="https://script.viserlab.com/ngolab/user/profile-setting"
                    class="dropdown-menu__item d-flex align-items-center px-3 py-2 border-0">
            ...
            <div class="bodywrapper__inner">
                ...
                <div class="card b-radius--10 mt-4">
                    <div class="card-header">
                        ...
                        <a href="https://script.viserlab.com/ngolab/user/payment-history/all"
                            class="btn btn-sm btn--primary box--shadow1 text--small float-right">View All</a>
                    </div>
                            ...
                            <table class="table table--light style--two">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="Late Fee">$0.00</td>
                                        <td data-label="Total Amount">$5.00</td>
                                        <td data-label="Date Time">2023-10-18 02:28 PM</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="Late Fee">$0.00</td>
                                        <td data-label="Total Amount">$5.00</td>
                                        <td data-label="Date Time">2023-10-04 02:31 AM</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="Type">Loan</td>
                                        <td data-label="Plan Name">Meredith Rowe</td>
                                        <td data-label="Paid Through"> Admin </td>
                                        <td data-label="Amount">$3.23</td>
                                        <td data-label="Late Fee">$1.03</td>
                                        <td data-label="Total Amount">$4.25</td>
                                        <td data-label="Date Time">2023-10-02 06:31 PM</td>
                                    </tr>

                                    <tr>
                                        <td data-label="S.N">6</td>
                                        <td data-label="Type">Loan</td>
                                        <td data-label="Plan Name">Amaya Fuller</td>
                                        <td data-label="Paid Through"> Admin </td>
                                        <td data-label="Amount">$6.64</td>
                                        <td data-label="Late Fee">$1.00</td>
                                        <td data-label="Total Amount">$7.64</td>
                                        <td data-label="Date Time">2023-10-02 06:31 PM</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="Late Fee">$0.00</td>
                                        <td data-label="Total Amount">$5.00</td>
                                        <td data-label="Date Time">2023-09-18 12:44 PM</td>
                                    </tr>
